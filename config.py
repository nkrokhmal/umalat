...
class BaseClass:
    ...
    TELEGRAM_CHAT_MOZZARELLA_ID = -589217420
    TELEGRAM_CHAT_RICOTTA_ID = -549987894
    TELEGRAM_CHAT_MASCARPONE_ID = -528527236
    TELEGRAM_CHAT_BUTTER_ID = -528527236
    TELEGRAM_CHAT_MILKPROJECT_ID = -525995076
...
class DebugConfig(BaseClass):
    TESTING = False
    # TELEGRAM_CHAT_ID = -704201850
    # TELEGRAM_CHAT_FILES_ID = -704201850
    # TELEGRAM_CHAT_MOZZARELLA_ID = -704201850
    # TELEGRAM_CHAT_RICOTTA_ID = -704201850
    # TELEGRAM_CHAT_MASCARPONE_ID = -704201850
    # TELEGRAM_CHAT_BUTTER_ID = -704201850
    # TELEGRAM_CHAT_MILKPROJECT_ID = -704201850
...
class TestConfig(BaseClass):
    ...
    TEST_STRESS_MOZZARELLA = "app/data/tests/stress_mozzarella"
    ...
    TELEGRAM_BOT_TOKEN = "1101281504:AAEbWzUXem-FK7Yb2RHvkg-h8sMilZAuFpA"
    # TELEGRAM_CHAT_ID = -633089546
    # TELEGRAM_CHAT_FILES_ID = -633089546
    # TELEGRAM_CHAT_MOZZARELLA_ID = -633089546
    # TELEGRAM_CHAT_RICOTTA_ID = -633089546
