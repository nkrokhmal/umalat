...
class BaseClass:
    ...
    TELEGRAM_CHAT_MOZZARELLA_ID = -1002087020502
    TELEGRAM_CHAT_RICOTTA_ID = -1002136579980
    TELEGRAM_CHAT_MASCARPONE_ID = -1002087244254
    TELEGRAM_CHAT_BUTTER_ID = -1002087244254
    TELEGRAM_CHAT_MILKPROJECT_ID = -1001990610621
