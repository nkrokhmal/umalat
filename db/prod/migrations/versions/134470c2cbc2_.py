...
Revision ID: 134470c2cbc2
Revises: 
Create Date: 2025-01-05 19:58:11.746616
...
def upgrade():
    ...
    sa.Column('additive', sa.String(), nullable=True),
    ...
    op.create_table('brynza_boilings',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=True),
    ...
    op.create_table('brynza_form_factors',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['form_factors.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('brynza_boiling_technologies',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('is_multihead_rubber', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['id'], ['skus.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('pouring_time', sa.Integer(), nullable=True),
    sa.Column('heating_time', sa.Integer(), nullable=True),
    sa.Column('heating_short_time', sa.Integer(), nullable=True),
