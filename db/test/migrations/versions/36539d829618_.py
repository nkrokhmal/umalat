...
Revision ID: 36539d829618
Revises: 
Create Date: 2022-01-13 18:47:20.367850
...
def upgrade():
    ...
    op.create_table('mozzarella_cooling_technologies',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('butter_boilings',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('weight_netto', sa.Float(), nullable=True),
    ...
    op.create_table('mascarpone_sourdoughs',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('milk_project_boilings',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=True),
    sa.Column('weight_netto', sa.Float(), nullable=True),
    sa.Column('output_kg', sa.Integer(), nullable=True),
    ...
    op.create_table('milk_project_form_factors',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['form_factors.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('mozzarella_boilings',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('mozzarella_form_factors',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('default_cooling_technology_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['default_cooling_technology_id'], ['mozzarella_cooling_technologies.id'], ),
    sa.ForeignKeyConstraint(['id'], ['form_factors.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('ricotta_form_factors',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['form_factors.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('output_ton', sa.Integer(), nullable=True),
    sa.Column('pumping_off_time', sa.Integer(), nullable=True),
    sa.Column('pumping_off_2_time', sa.Integer(), nullable=True),
    sa.Column('pumping_off_pause_time', sa.Integer(), nullable=True),
    ...
    op.create_table('milk_project_skus',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['skus.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('mozzarella_boiling_technologies',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('pouring_time', sa.Integer(), nullable=True),
    ...
    op.create_table('mozzarella_skus',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('ricotta_boiling_technologies',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('heating_time', sa.Integer(), nullable=True),
    ...
    op.create_table('boiling_technology_sourdough',
    sa.Column('sourdough_id', sa.Integer(), nullable=False),
    sa.Column('boiling_technology_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['boiling_technology_id'], ['mascarpone_boiling_technologies.id'], ),
    sa.ForeignKeyConstraint(['sourdough_id'], ['mascarpone_sourdoughs.id'], ),
    sa.PrimaryKeyConstraint('sourdough_id', 'boiling_technology_id')
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('boiling_technology_sourdough')
    ...
    op.drop_table('mascarpone_sourdoughs')
