...
from app.scheduler.contour_cleanings.tests.test_frontend import test_batch as test_contour_cleanings_batch
from app.scheduler.mascarpone.tests.test_frontend import test_batch as test_mascarpone_batch
from app.scheduler.mascarpone.tests.test_parser_new import test_batch as test_mascarpone_parser_batch
from app.scheduler.mascarpone.tests.test_properties import test_batch as test_mascarpone_properties_batch
from app.scheduler.milk_project.tests.test_frontend import test_batch as test_milk_project_batch
from app.scheduler.milk_project.tests.test_parser_new import test_batch as test_milk_project_parser_batch
from app.scheduler.milk_project.tests.test_properties import test_batch as test_milk_project_properties_batch
from app.scheduler.mozzarella.tests.test_frontend import test_batch as test_mozzarella_batch
from app.scheduler.mozzarella.tests.test_parser_new import test_batch as test_mozzarella_parser_batch
from app.scheduler.mozzarella.tests.test_properties import test_batch as test_mozzarella_properties_batch
