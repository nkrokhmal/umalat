...
def get_boiling_technology():
    ...
    return render_template('mozzarella/get_boiling_technology.html', boiling_technologies=boiling_technologies, endpoints='.get_boiling')


@main.route('/mozzarella/edit_boiling_technology/<int:boiling_technology_id>', methods=['GET', 'POST'])
def edit_boiling_technology(boiling_technology_id):
    ...
    if boiling_technology.boilings[0].line is not None:
        form.line.default = default_form_value(form.line, boiling_technology.boilings[0].line.name)
    ...
    return render_template('mozzarella/edit_boiling_technology.html', form=form, boiling_technology_id=boiling_technology.id)
