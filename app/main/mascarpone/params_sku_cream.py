...
@main.route("/mascarpone/copy_sku_cream/<int:sku_id>", methods=["GET", "POST"])
@flask_login.login_required
def mascarpone_copy_sku_cream(sku_id):
    form = CopySKUForm()
    ...
    return flask.render_template("mascarpone/copy_sku_cream.html", form=form, sku_id=sku.id)
