    ...
    data = [
        {
            ...
            'Охлаждение 1(для воды)': "" if not sku.form_factor.default_cooling_technology else sku.form_factor.default_cooling_technology.first_cooling_time,
            'Охлаждение 2(для воды)': "" if not sku.form_factor.default_cooling_technology else sku.form_factor.default_cooling_technology.second_cooling_time,
            'Время посолки': "" if not sku.form_factor.default_cooling_technology else sku.form_factor.default_cooling_technology.salting_time,
