...
if __name__ == "__main__":
    utils.configure_loguru(level="INFO")
    # _test(
    #     # config.abs_path(
    #     #     "/Users/marklidenberg/Desktop/2021-09-11 Расписание моцарелла (2).xlsx"
    #     # ),
    #     "/Users/marklidenberg/Yandex.Disk.localized/master/code/git/2020.10-umalat/umalat/app/data/static/samples/inputs/by_department/mozzarella/План по варкам моцарелла 7.xlsx",
