...
def _test(fn, *args, **kwargs):
    ...
    outputs = run_mozzarella(fn, optimize=False, *args, **kwargs)
...
if __name__ == "__main__":
    ...
    _test(
        ...
        # ),
        "/Users/marklidenberg/Yandex.Disk.localized/master/code/git/2020.10-umalat/umalat/app/data/static/samples/inputs/by_department/mozzarella/План по варкам моцарелла 8 оптимизация первой варки последней линии 2.xlsx",
