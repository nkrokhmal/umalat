...
def update_interval_times(schedule_wb, boiling_plan_df):
    ...
    boiling_plan_df['start'] = boiling_plan_df['absolute_batch_id'].apply(lambda batch_id: interval_times.get(batch_id, [None, None])[0])
    boiling_plan_df['finish'] = boiling_plan_df['absolute_batch_id'].apply(lambda batch_id: interval_times.get(batch_id, [None, None])[1])
