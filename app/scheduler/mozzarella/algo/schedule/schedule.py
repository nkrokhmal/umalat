...
from app.scheduler.mozzarella.algo.schedule.start_configuration_optimization import (
    optimize_schedule_by_start_configuration,
)
from app.scheduler.mozzarella.boiling_plan.boiling_plan import cast_boiling_plan


def make_schedule(boiling_plan_obj, optimize=True, exact_melting_time_by_line=None, *args, **kwargs):
