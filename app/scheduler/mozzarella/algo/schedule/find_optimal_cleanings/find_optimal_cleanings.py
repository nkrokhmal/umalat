...
def find_optimal_cleanings(
    ...
    **kwargs,
    ...
    schedule = make_schedule_from_boilings(boilings, start_times=start_times, **kwargs)
...
def test():
    ...
    boiling_plan_fn = r"/Users/arsenijkadaner/FileApps/coding_projects/umalat/app/data/static/samples/inputs/by_department/mozzarella/2023-06-02 План по варкам моцарелла.xlsx"
