...
def test():
    output = draw_frontend(
        str(get_repo_path() / "app/data/static/samples/by_department/butter/sample_schedule_butter.xlsx")
    )

    output["workbook"].save("/tmp/butter_schedule.xlsx")
    open_file_in_os("/tmp/butter_schedule.xlsx")
