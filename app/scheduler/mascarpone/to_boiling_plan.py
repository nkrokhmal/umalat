...
def to_boiling_plan(
    ...
    - washing: нужна ли мойка после данной варки. Указывается руками в плане варок  # todo later: где это в расписании?

    В id в маскарпоне бардак. # todo later: прибраться
    - group_id: по смыслу boiling_id
    - boiling_id: непонятный id, считается как-то хитро
    - block_id: по смыслу group_id
    - id: непонятный id'шник
    """
