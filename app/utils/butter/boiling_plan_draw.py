...
COLUMNS = {
    ...
    "name": Cell(column_index_from_string("D"), "E"),
    "plan": Cell(column_index_from_string("E"), "G"),
    "remainings": Cell(column_index_from_string("F"), "F"),
    "total_output": Cell(column_index_from_string("J"), "J"),
    "delimiter": Cell(column_index_from_string("H"), "H"),
    "delimiter_int": Cell(column_index_from_string("K"), "K"),
}
