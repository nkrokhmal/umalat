...
def make_cooling_process(line_name, cooling_technology, melting_process_size=None, size=None, *args, **kwargs):
    ...
    with make('start'):
        cooling_times = [cooling_technology.first_cooling_time, cooling_technology.second_cooling_time] if line_name == LineName.WATER else [cooling_technology.salting_time]
