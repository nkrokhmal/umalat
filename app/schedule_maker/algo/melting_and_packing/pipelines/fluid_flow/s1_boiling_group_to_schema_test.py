...
def test():
    df = read_boiling_plan(
        os.path.join(basedir, r"app/schedule_maker/data/sample_boiling_plan.xlsx")
    )
...
def test2():
    df = read_boiling_plan(
        r"C:\Users\Mi\Desktop\code\git\2020.10-umalat\umalat\research\akadaner\Реальные расписания\2021-01-19 План по варкам.xlsx"
    )
