def load_style(mode='prod'):
    ...
    row_style_dev = {
        ...
        'packing_and_preconfiguration': {'y': lambda b: 13 if b.abs_props['boiling_type'] == 'water' else 27},
        'cleaning': {'y': 29}
    }
    ...
    row_style_prod = {
        ...
        'packing_and_preconfiguration': {'y': lambda b: 29 if b.abs_props['boiling_type'] == 'water' else 46},
        'cleaning': {'y': 12}
    }
